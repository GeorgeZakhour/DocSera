...
abstract class AppLocalizations {
  ...
  /// No description provided for @earnPointsReferral.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @transactionWelcome.
  ///
  /// In en, this message translates to:
  /// **'Welcome bonus'**
  String get transactionWelcome;

  /// No description provided for @transactionAppointment.
  ///
  /// In en, this message translates to:
  /// **'Appointment reward'**
  String get transactionAppointment;

  /// No description provided for @transactionRedeemed.
  ///
  /// In en, this message translates to:
  /// **'Offer redeemed'**
  String get transactionRedeemed;

  /// No description provided for @processingNote.
  ///
  /// In en, this message translates to:
  /// **'Points are processed within 72 hours'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Spend {points} points on this offer?'**
  String redeemConfirmMessage(int points);

  /// No description provided for @goToVouchers.
  ///
  /// In en, this message translates to:
  /// **'View My Vouchers'**
  String get goToVouchers;

  /// No description provided for @referralReward.
  ///
  /// In en, this message translates to:
  /// **'You earn 25 points, your friend earns 15!'**
  ...
  /// No description provided for @freeFirstConsultation.
  ///
  /// In en, this message translates to:
  /// **'Free First Consultation'**
  String get freeFirstConsultation;
  ...
  /// No description provided for @newPatientsOnly.
  ///
  /// In en, this message translates to:
  /// **'New Patients Only'**
  String get newPatientsOnly;
  ...
  /// No description provided for @claimOfferDesc.
  ///
  /// In en, this message translates to:
  ...
  /// In en, this message translates to:
  /// **'Valid for 7 days'**
  String get voucherExpiry;

  /// No description provided for @showCodeToDoctor.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @offerFull.
  ///
  /// In en, this message translates to:
  /// **'This offer has reached the maximum number of claims'**
  String get offerFull;
  ...
  /// No description provided for @apptConfirmTitle.
  ///
  /// In en, this message translates to:
  /// **'Confirm appointment'**
  String get apptConfirmTitle;

  /// No description provided for @apptConfirmKind.
  ///
  /// In en, this message translates to:
  /// **'New booking awaiting your confirmation'**
  String get apptConfirmKind;

  /// No description provided for @apptConfirmIntro.
  ///
  /// In en, this message translates to:
  /// **'{doctorName} booked this appointment for you. Please confirm if you recognize it, or dispute if you didn\'t request it.'**
  String apptConfirmIntro(String doctorName);

  /// No description provided for @apptConfirmIntroRelative.
  ///
  /// In en, this message translates to:
  /// **'{doctorName} booked an appointment for your relative. Please confirm if you\'re aware of it, or dispute if you didn\'t request it.'**
  String apptConfirmIntroRelative(String doctorName);

  /// No description provided for @apptConfirmDateLabel.
  ///
  /// In en, this message translates to:
  /// **'Date & time'**
  String get apptConfirmDateLabel;

  /// No description provided for @apptConfirmReasonLabel.
  ///
  /// In en, this message translates to:
  /// **'Reason for visit'**
  String get apptConfirmReasonLabel;

  /// No description provided for @apptConfirmClinicLabel.
  ///
  /// In en, this message translates to:
  /// **'Clinic'**
  String get apptConfirmClinicLabel;

  /// No description provided for @apptConfirmWhyTitle.
  ///
  /// In en, this message translates to:
  /// **'Why do we ask?'**
  String get apptConfirmWhyTitle;

  /// No description provided for @apptConfirmWhyBody.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @apptConfirmCta.
  ///
  /// In en, this message translates to:
  /// **'Confirm appointment'**
  String get apptConfirmCta;

  /// No description provided for @apptConfirmDisputeCta.
  ///
  /// In en, this message translates to:
  /// **'I didn\'t book this'**
  String get apptConfirmDisputeCta;

  /// No description provided for @apptConfirmDisputeNote.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @apptConfirmNotFoundTitle.
  ///
  /// In en, this message translates to:
  /// **'This appointment is no longer available'**
  String get apptConfirmNotFoundTitle;

  /// No description provided for @apptConfirmNotFoundBody.
  ///
  /// In en, this message translates to:
  /// **'It may have been cancelled or already confirmed from another device.'**
  String get apptConfirmNotFoundBody;

  /// No description provided for @apptConfirmActionedTitle.
  ///
  /// In en, this message translates to:
  /// **'Already settled'**
  String get apptConfirmActionedTitle;

  /// No description provided for @apptConfirmActionedBody.
  ///
  /// In en, this message translates to:
  /// **'This appointment has already been confirmed or cancelled. No further action is needed.'**
  String get apptConfirmActionedBody;

  /// No description provided for @apptConfirmResultConfirmedTitle.
  ///
  /// In en, this message translates to:
  /// **'Appointment confirmed'**
  String get apptConfirmResultConfirmedTitle;

  /// No description provided for @apptConfirmResultConfirmedBody.
  ///
  /// In en, this message translates to:
  /// **'Your appointment with {doctorName} is confirmed. You\'ll find it in your appointments list, and you can message each other through the app.'**
  String apptConfirmResultConfirmedBody(String doctorName);

  /// No description provided for @apptConfirmResultDisputedTitle.
  ///
  /// In en, this message translates to:
  /// **'Appointment cancelled'**
  String get apptConfirmResultDisputedTitle;

  /// No description provided for @apptConfirmResultDisputedBody.
  ///
  /// In en, this message translates to:
  /// **'The appointment has been cancelled. {doctorName} won\'t be able to auto-add you again — they\'ll need to send a connection request if they want to reach you.'**
  String apptConfirmResultDisputedBody(String doctorName);

  /// No description provided for @apptConfirmDispatchedToast.
  ///
  /// In en, this message translates to:
  /// **'Your response has been recorded.'**
  String get apptConfirmDispatchedToast;

  /// No description provided for @apptConfirmErrorToast.
  ///
  /// In en, this message translates to:
  /// **'Couldn\'t complete the request. Please try again.'**
