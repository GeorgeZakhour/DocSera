...
class AppLocalizationsAr extends AppLocalizations {
  ...
  @override
  String get thisPatientCannotMessageDoctor => 'عذرًا، هذا المريض لا يمكنه إرسال رسالة إلى الطبيب';
  ...
  @override
  String get failedToLoadReasons => 'فشل تحميل أسباب المراسلة، يُرجى المحاولة لاحقًا.';

  @override
  String get noReasonsAddedByDoctor => 'هذا الطبيب لم يضف أي أسباب للمراسلة بعد.';
