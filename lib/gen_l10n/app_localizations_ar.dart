...
class AppLocalizationsAr extends AppLocalizations {
  ...
  @override
  String get archivedOfferTag => 'لم يعد متاحاً';
  ...
  String archivedOfferBannerDescriptionWithExpiry(String expiry) {
    return 'أوقف الطبيب أو المركز هذا العرض. وبما أنك حصلت على الرمز مسبقاً، يبقى صالحاً حتى $expiry. اعرضه في زيارتك القادمة قبل انتهاء صلاحيته.\n\nملاحظة: يحق للطبيب أو المركز سحب أي رمز متى شاء، لذا يُفضّل استخدامه في أقرب وقت.';
  }

  @override
  String get archivedOfferBannerDescriptionNoExpiry =>
      'أوقف الطبيب أو المركز هذا العرض. وبما أنك حصلت على الرمز مسبقاً، يبقى صالحاً وليس له تاريخ انتهاء محدد — اعرضه في زيارتك القادمة.\n\nملاحظة: يحق للطبيب أو المركز سحب أي رمز متى شاء، لذا يُفضّل استخدامه في أقرب وقت.';
