...
import 'package:docsera/screens/home/health/pages/other/add_other_bottom_sheet.dart';

class OtherRecordsPage extends StatelessWidget {
  const OtherRecordsPage({super.key});
    ...
    return BlocProvider(
      ...
      child: BlocListener<PatientSwitcherCubit, PatientSwitcherState>(
        ...
        listener: (context, state) {
          ...
          debugPrint(
              "🔁 [OtherRecordsPage] patient changed → userId=${state.userId}, relativeId=${state.relativeId}");
            ...
            builder: (context, state) {
              ...
              return FloatingActionButton.extended(
                onPressed: () {
                  ...
                  _openAddOtherBottomSheet(context, cubit);
                },
                backgroundColor: AppColors.main,
                elevation: 0,
                ...
                builder: (context, state) {
                  ...
                  if (state.records.isEmpty) {
                    return HealthEmptyView(
                      imagePath: 'assets/images/health/allergy_3d.webp', // Can change if needed
                      title: t.health_other_title,
                      subtitle: t.health_other_desc,
  ...
  void _openAddOtherBottomSheet(BuildContext context, HealthCubit cubit) {
    showModalBottomSheet(
      ...
      builder: (_) {
        return BlocProvider.value(
          value: cubit,
          child: const AddOtherBottomSheet(),
        );
      },
    );
  }
...
class _OtherRecordsList extends StatelessWidget {
  final List<HealthRecord> records;
  final void Function(String id) onDelete;

  const _OtherRecordsList({
  ...
  void _openDetails(BuildContext context, HealthRecord record) {
    ...
    showDialog(
      ...
      builder: (_) => HealthRecordDetailsDialog(
        ...
        rows: [
          DetailRow(t.health_other_title, name),
  ...
  void _openDelete(BuildContext context, String id) {
    ...
    showDialog(
      ...
      builder: (_) => HealthDeleteConfirmDialog(
        title: t.delete,
        message: t.delete, // generic fallback
        deleteText: t.delete,
        cancelText: t.cancel,
        onConfirm: () {
          Navigator.pop(context);
