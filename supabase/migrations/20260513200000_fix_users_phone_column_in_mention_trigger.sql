-- =============================================================================
-- Hotfix: fn_notify_memo_note_mentions referenced public.users.phone, but the
-- column is named phone_number. Saving a note with mentions raised
-- `column "phone" does not exist (42703)` and rolled back the INSERT —
-- the user couldn't save the note at all.
-- =============================================================================
...
BEGIN
  ...
  LOOP
    ...
    -- Was: phone (does not exist). Fixed: phone_number.
    SELECT
      COALESCE(
