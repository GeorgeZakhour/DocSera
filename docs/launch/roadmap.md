...
| 7 | CI (GitHub Actions) — analyze + tests + Android debug build + iOS no-codesign build on every push and PR; stale tests parked in `test/_pending_rewrite/`; APK uploaded as artifact | [08-ci-github-actions.md](08-ci-github-actions.md) | 9.3 |
